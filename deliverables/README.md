...
| `reveal-live-1920x1080.mp4` | The same reveal as a presentation cut, 17 s at 60 fps: the panel stands at its own aspect on the left, and the beat names come up beside it as each one lands. |
| `reveal-live-960.gif`, `reveal-live-1080x3840-poster.jpg`, `reveal-live-1920x1080-poster.jpg` | The reveal as a GIF and as stills, the moment the big score lands. |
| `run-live-1920x1080.mp4` | **The second clip.** One turn on the phone, about 36 s at 60 fps, the replay playing through to its end: home, the code on the cabinet, the link, a credit picked and paid for with the phone's own wallet, the pad, the strike, the number landing in your hand and the replay ready to share. The phone stands at its own size beside the beat names. |
