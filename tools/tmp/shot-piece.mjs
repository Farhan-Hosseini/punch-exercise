...
ws.close(); chrome.kill(); setTimeout(() => { try { rmSync(join(tmpdir(), 'sp' + port), { recursive: true, force: true }) } catch { /* still held */ } }, 600)   // the profile is 57 MB; leave nothing behind
